...
function createEl({ name, date, comment, id, liked }) {
  ...
  <div class="item__title">
    ...
    <button class="btn_like"><svg class="btn-like__icon ${
			liked ? "liked" : ""
...
function saveComment(name, date, comment) {
	...
	const commentEl = createComment(name, savedDate, comment);
	publishedComments.push(commentEl);
	setToLocalStorage("publishedComments", publishedComments);
	list.append(createEl(commentEl));
}
